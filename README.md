...
- сводный status, DAU/WAU/MAU, latency ICM, гео устройств, блокировка пользователей,
  клиентские крэши, rate limits, JSON-backup и безопасный перевыпуск LMG admin-key;
