...
fun LiquidBottomTabsBare(
    ...
    BoxWithConstraints(
        ...
        val dampedDragAnimation = remember(animationScope) {
            org.gsgit.admin.ui.kyant.utils.DampedDragAnimation(
        ...
        // Скрытая акцентная копия ряда: проступает сквозь стеклянный индикатор.
        ...
        // Плавающая стеклянная капсула-индикатор.
        Box(
            Modifier
                .padding(horizontal = 4f.dp)
                .graphicsLayer {
